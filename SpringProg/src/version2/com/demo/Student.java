...
public class Student {
	...
	public String toString() {
		return "Student [s_nm=" + s_nm + ", s_hobby=" + s_hobby + ", mobile=" + mobile + ", DOB=" + DOB + ", s_skill="
				+ s_skill + ", s_info=" + s_info + ", getS_info()=" + getS_info() + ", getS_nm()=" + getS_nm()
				+ ", getS_hobby()=" + getS_hobby() + ", getMobile()=" + getMobile() + ", getDOB()=" + getDOB()
				+ ", getS_skill()=" + getS_skill()+ "]";
	}
